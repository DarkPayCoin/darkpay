...
This mechanism has been integrated into Bitcore-Node-DARKPAYCOIN which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/DARKPAYCOIN-Project/insight-api-darkpaycoin#web-socket-api](https://github.com/DARKPAYCOIN-Project/insight-api-darkpaycoin#web-socket-api) 
* API: [https://github.com/DARKPAYCOIN-Project/insight-api-darkpaycoin#swifttx-transactions](https://github.com/DARKPAYCOIN-Project/insight-api-darkpaycoin#swifttx-transactions) 
