...
In order to support loading of multiple wallets in darkpaycoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is darkpaycoin.cpp.
...
Changes to darkpaycoin.cpp
----------------------
darkpaycoin.cpp is the entry point into darkpaycoin-qt, and as such, will require some minor modifications to provide hooks for
