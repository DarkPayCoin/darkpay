...
static void NotifyzDKPCReset(WalletModel* walletmodel)
{
    qDebug() << "NotifyzDKPCReset";
...
void WalletModel::subscribeToCoreSignals()
{
    ...
    wallet->NotifyzDKPCReset.connect(boost::bind(NotifyzDKPCReset, this));
...
void WalletModel::unsubscribeFromCoreSignals()
{
    ...
    wallet->NotifyzDKPCReset.disconnect(boost::bind(NotifyzDKPCReset, this));
