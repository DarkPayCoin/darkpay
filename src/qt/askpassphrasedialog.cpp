                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zDKPC || context == Context::BIP_38) {
    ...
    // It doesn't make sense to show the checkbox for sending DKPC because you wouldn't check it anyway.
    if (context == Context::Send_DKPC || context == Context::Send_zDKPC) {
