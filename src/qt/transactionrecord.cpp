...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zdkpcTracker->HasMintTx(hash))) {
            //zDKPC stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZDKPC;
...
bool IsZDKPCType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZDKPC:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZDKPC || type == TransactionRecord::MNReward) {
