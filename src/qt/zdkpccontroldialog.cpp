...
bool CZDkpcControlWidgetItem::operator<(const QTreeWidgetItem &other) const {
    int column = treeWidget()->sortColumn();
    if (column == ZDkpcControlDialog::COLUMN_DENOMINATION || column == ZDkpcControlDialog::COLUMN_VERSION || column == ZDkpcControlDialog::COLUMN_CONFIRMATIONS)
...
void ZDkpcControlDialog::updateList()
{
    ...
    for (auto denom : libzerocoin::zerocoinDenomList) {
        CZDkpcControlWidgetItem* itemDenom(new CZDkpcControlWidgetItem);
    ...
    for (const CMintMeta& mint : setMints) {
        ...
        CZDkpcControlWidgetItem *itemMint = new CZDkpcControlWidgetItem(ui->treeWidget->topLevelItem(mapDenomPosition.at(denom)));
