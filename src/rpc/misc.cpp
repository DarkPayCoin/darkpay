...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"darkpaycoinaddress\"\n"
            "\nReturn information about the given darkpaycoin address.\n"

            "\nArguments:\n"
            "1. \"darkpaycoinaddress\"     (string, required) The darkpaycoin address to validate\n"

            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"darkpaycoinaddress\", (string) The darkpaycoin address validated\n"
