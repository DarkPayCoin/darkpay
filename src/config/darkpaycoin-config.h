/* src/config/darkpaycoin-config.h.  Generated from darkpaycoin-config.h.in by configure.  */
/* src/config/darkpaycoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef DKPC_CONFIG_H

#define DKPC_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.darkpaycoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Darkpaycoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Darkpaycoin Core 3.1.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "darkpaycoin"
